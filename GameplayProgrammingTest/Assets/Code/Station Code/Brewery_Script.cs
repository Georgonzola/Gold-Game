...
public class Brewery_Script : MonoBehaviour
{
    ...
    public float brewNum = 0.0f;
    public float brewSpeed = 0.5f;
    ...
    public void Brew(Gold_Script goldObject)
    {

        brewNum += brewSpeed * Time.deltaTime; ;
        progBar.enabled = true;
        barBG.enabled = true;

        float temp = 0f + (brewNum - 0f) * (1f - 0f) / (10f - 0f);
