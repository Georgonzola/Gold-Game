...
public class Press_Script : MonoBehaviour
{
    ...
    public void Press(Gold_Script goldObject)
    {
        ...
        if (goldObject.smeltNum >= 2.5f && goldObject.subStateName == "GoldBar")
        {
            ...
            float temp = 0f + (pressNum - 0f) * (1f - 0f) / (10f - 0f);
            ...
            {
                pressNum -= pressSpeed * Time.deltaTime;
